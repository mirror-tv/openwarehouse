'use strict';
import { Button, FormField, FormInput, Modal, ModalHeader, ModalBody, ModalFooter } from 'cornerstone-elemental';
	...
	render() {
		return (
			<Modal isOpen={this.props.isModalOpen} onCancel={this.toggleModal} backdropClosesModal>
				<ModalHeader text={'Insert ' + this.props.label} showCloseButton onClose={this.toggleModal} />
				<ModalBody>

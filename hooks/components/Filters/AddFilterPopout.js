...
import PopoutForm from '@keystonejs/app-admin-ui/client/pages/List/Filters/PopoutForm'
import {
    DisclosureArrow,
    POPOUT_GUTTER,
} from '@keystonejs/app-admin-ui/client/components/Popout'
import { ErrorBoundary } from '@keystonejs/app-admin-ui/client/components/ErrorBoundary'
                    ...
                    return (
                        <div ref={ref} style={style}>
                            <FieldSelect
                                ...
                                isOptionDisabled={
                                    this.doesNotHaveAvailableFilterTypes
                                }
    ...
    renderFilterUI = ({ ref }) => {
        ...
        return (
            <Transition
                ...
                timeout={220}
                onEntered={
                    filter ? this.focusFilterRef : this.focusFilterSelect
                }
            >
                {(state) => {
                    const base = {
                        ...
                        return (
                            <div ref={ref} style={style}>
                                <Alert appearance="warning" variant="bold">
                                    ...
                                    >
                                        Could not find a <Code>Filter</Code>{' '}
                                        view for field type{' '}
                            ...
                            {options.length > 1 ? (
                                <EventCatcher>
                                    <Select
                                        ...
                                        isOptionDisabled={
                                            this.matchesExistingFilterType
                                        }

const newDateTime = require('../../../../fields/NewDateTime')
...
const createdAt = (options) =>
    _atTracking({ created: true, updated: false })(options)
const updatedAt = (options) =>
    _atTracking({ created: false, updated: true })(options)
const atTracking = (options) =>
    _atTracking({ created: true, updated: true })(options)
